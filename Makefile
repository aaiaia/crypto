# ============================================================
# makefile v1
# url: https://github.com/aaiaia/make_c/tree/main/v1
# ============================================================
# default C language make environment
CC = gcc
CFLAGS = -fPIC -DTEST_AES -DTEST_ENDIAN -DTEST_SHA -DTEST_HMAC			# gcc compile flags, when use compile and linking
#CFLAGS = -fPIC -DTEST_AES -DTEST_ENDIAN -DTEST_SHA -DTEST_HMAC -DDEBUG	# gcc compile flags, when use compile and linking
# default C++ language make environment
CXX = g++
